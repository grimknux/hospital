...
var CompCharts = function() {
    ...
    return {
        init: function(jsonR,jsonW,jsonWR) {
            ...
            // Data for the charts
			//alert(jv);
            //var dataRoutine    = [[1, 1900],[2, 2300],[3, 3200],[4, 2500],[5, 4200],[6, 3100],[7, 3600],[8, 2500],[9, 4600],[10, 3700],[11, 4200],[12, 5200]];
			
			var dataRoutine=JSON.parse(jsonR);
			var dataWorkshop=JSON.parse(jsonW);
			var dataResource=JSON.parse(jsonRW);
            //var dataWorkshop       = [[1, 850], [2, 750], [3, 1500], [4, 900], [5, 1500], [6, 1150], [7, 1500], [8, 900], [9, 1800], [10, 1700], [11, 4000], [12, 2550]];
			
            //var dataResource     = [[1, 130], [2, 330], [3, 220], [4, 350], [5, 150], [6, 275], [7, 280], [8, 380], [9, 120], [10, 330], [11, 190], [12, 410]];
                ...
                if (item) {
                    if (previousPoint !== item.dataIndex) {
                        ...
                        if (item.seriesIndex === 0) {
                            ttlabel = '<strong>' + y + '</strong> Responses';
            ...
            // Stacked Chart
            $.plot(chartStacked,
                [{label: 'Tickets', data: dataResource}, {label: 'Sales', data: dataWorkshop}, {label: 'Earnings', data: dataRoutine}],
                {
